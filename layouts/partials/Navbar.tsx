...
const Navbar = (props : NavbarProps) => {
  const {active} = props
  return (
    <div className={`fixed top-0 left-0 right-0 py-2 z-50 md:px-10 px-2 ${active ? 'bg-slate-500 text-white shadow-lg duration-300' : 'bg-transparent text-black shadow-none duration-300' }`}>
